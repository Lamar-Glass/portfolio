...
function RecentCertsCard({ pic, heading, discr, tags = [] }) {
    ...
    >
      ...
      <div className="flex-1 space-y-2 sm:space-y-3 relative z-10 w-full">
        <div className="flex items-center gap-3">
          ...
          <span className="text-[9px] sm:text-[10px] text-orange-500 font-bold tracking-[0.2em] uppercase opacity-70">Featured Certificate</span>
        </div>
...
export default RecentCertsCard;
